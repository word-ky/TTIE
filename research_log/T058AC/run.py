...
from research_log.T058AC.chain import full_chain,CREDIBLE,UNRESOLVED
import copy
...
prior_root=Path('/home/wenchang/asdasdsad/wjq/TTIE/runs/20260917-092633-ttie-t058ab-full')
prior_files=json.loads(Path('research_log/T058AB_archives.json').read_bytes())['files']
