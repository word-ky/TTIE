...
p=argparse.ArgumentParser();p.add_argument('--evaluation-run',required=True);a=p.parse_args();base=Path('/home/wenchang/asdasdsad/wjq/TTIE');run=base/'runs/20260917-003927-ttie-t056a-oracle';pre=base/'runs/20260917-003838-ttie-t056a-preflight';ev=base/'runs'/a.evaluation_run;out=base/'shared/t056a';out.mkdir(exist_ok=True);backup=Path('/media/wenchang/F/wjq/TTIE/shared/t056a');backup.mkdir(exist_ok=True);audit=run/'artifacts/REFERENCE_ORACLE_ONLY'
...
metadata=out/'T056A_metadata.tar.gz'
