...
Tested source e3bbf12c701d642a215afc049ca05cf9017feed1, branch codex/T052A-spatial-affine, exact accepted T051 base78d24ef2365ec2a8b3e18036a9154ec9f833e9d9. T051 freeze d66edca57c6cac1ffe15a428552c73e2e343363165a2808f16a1b01cce460667, pairs ecc607ac2c04a21d5ad53c06264f22869e0ee3f65810c22d952b5bbec665be2f. T050 pairs2f3cf008677427fec0a1be0202e63272b1cd6d275957f295972161ec237716d1 are embedded in hash-bound T051 pairs. Cohort b88c8347005984b5523b117b52c0c068672fe172eb7c9aa5b60102d350e2d85b. The74 original source bindings preserved in T052A_tested_source_binding.json were verified before deployment and persisted in preflight/config, including the original replay. T052A_source_binding.json separately identifies the post-run corrected verifier; it was not the manifest persisted by this experiment.
...
## Research-lead adjudication and publication
...
Research lead must adjudicate verifier-only correction under concurrent EXEC no-source-edit rule. No rerun, noT053.
...
Publication: `PUBLISHED_PARTIAL_AWAIT_REVIEW`; main mailbox c09b5bb07cc1c299b83738518582b580f8681f0f. Recovery: `{"files": 214, "bytes": 20540755, "sha256": "3306f35d76dbf6c31214a161a7f55b150c68f2e5d8f1907d147418b66715ab86", "evidence_head": "9de9fbefd588baa1ae6683cbbafe66962bb9ab5a", "main_mailbox_sha": "c09b5bb07cc1c299b83738518582b580f8681f0f", "path": "research_log\\T052A_recovery.tar.gz", "home_path": "/home/wenchang/asdasdsad/wjq/TTIE/shared/t052a/T052A_recovery.tar.gz", "backup_path": "/media/wenchang/F/wjq/TTIE/shared/t052a/T052A_recovery.tar.gz", "verified_home_and_backup": true, "verification_note": "Initial SSH verification connection closed255 after upload; same artifact verified on reconnect, no transfer/rerun needed."}`.

Recorded failures: `["Initial baseline pytest from outercwd failed import; corrected worktree/PYTHONPATH before edits, baseline then passed", "Initial replay coordinate rounding mismatch; verifier-only correction, unchanged tolerance/trajectory/metrics", "GitHub fetch connection timeout once; reconnect succeeded", "Recovery verification SSH255 once after successful upload; reconnect verified existing archive in home/F"]`.
