...
- Official public-source descriptions: [DCTTA](https://github.com/tonia86/DCTTA), [QuadPrior](https://github.com/daooshee/QuadPrior), [ZERO-IG](https://github.com/Doyle59217/ZeroIG), [MR. Illuminate paper](https://openaccess.thecvf.com/content/CVPR2026/html/Cho_MR._Illuminate_Zero-Shot_Low-Light_Image_Enhancement_with_Diffusion_Prior_CVPR_2026_paper.html). These identify intended regimes, not yet local executable binding hashes.
