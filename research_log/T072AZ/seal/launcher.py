...
SPEC_SHA='feb5c9445ecd4bde4821515921e325fc8c20bd7cca16b96b5854aa335b4d6b1b'
...
def choose(snapshot):
    ...
    for row in snapshot['gpus']:
        ...
        if row['name']=='NVIDIA GeForce RTX 4090' and row['free_mib']>=40960 and all(p['memory_mib']<=1024 for p in apps):eligible.append(row['index'])
