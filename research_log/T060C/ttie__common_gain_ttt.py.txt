"""T036-A common-gain wiring; exact accepted T026 trajectory and energy features."""
import torch
from .semantic_ttt import FixedObjective,Region2,EVGamma,grid_ranges
from .common_gain import CommonBox as ActionBox,CommonRegion2
...
def make_model(objective,image,basis):
    if basis=='region2':return CommonRegion2(objective.active).to(image)
