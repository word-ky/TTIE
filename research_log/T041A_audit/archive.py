"""Preserve complete T041 source diagnostic runs and compact reviewer evidence."""
from pathlib import Path
import json,hashlib,tarfile,shutil,sys
from datetime import datetime,timezone
home=Path('/home/wenchang/asdasdsad/wjq/TTIE');backup=Path('/media/wenchang/F/wjq/TTIE/shared/t041a');shared=home/'shared/t041a'
...
archives={}
for name,path,full in [('full',backup/'T041A_full.tar',True),('compact',shared/'T041A_compact.tar.gz',False)]:
...
copy=backup/'T041A_compact.tar.gz';shutil.copyfile(shared/'T041A_compact.tar.gz',copy);assert sha(copy)==archives['compact']['sha256']
...
for folder in [shared,backup]:(folder/'T041A_archives.json').write_text(json.dumps(receipt,indent=2)+'\n')
