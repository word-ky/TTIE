...
binding=json.loads(Path('research_log/T059V/source_binding.json').read_bytes());selection=json.loads(Path('research_log/T059V/selection.json').read_bytes());inputs=selection['inputs']
