...
- Fresh/final benchmark sets must remain isolated from model/hyperparameter selection. **The official LOL-v2 Real test remains untouched through T059-F2.**
...
- **Matched-detail source-fit candidate:** T059-BF/T059-C2/T059-D/T059-E/T059-F2 line. In-source fitting succeeds, but both held-out fitting recipes fail their transfer gates; additive centering and strict-positive scale decomposition do not explain away the held-out scalar failure. This line is **not deployable** and cannot proceed to real-domain detail rollout without a scientifically justified cross-image generalization fix and fresh validation.
...
PR #75/T050 is merged as `276c0b1fa5c9e6548bef90048ec6fcc43da439c3`. PRs #76–#83 inherit evidence-history/integration complications; preserve exact accepted scientific/evidence states rather than rewriting history during experiment cycles. PR #83/T057 may remain non-mergeable for history reasons; that does not invalidate its reviewed scientific evidence. PR #95/T058-AF, PR #99/T059-BF, PR #101/T059-C2, PR #102/T059-D, PR #103/T059-E, and PR #105/T059-F2 are likewise scientifically reviewable despite inherited history; do not repair history inside experiment cycles.

## Current open task

**T059-G — frozen 28-D cross-image feature-support 1-NN audit** in `coordination/CHATGPT_TO_CODEX.md`.

Use the accepted T059-E inner-train/inner-held split and exact 28-D standardized feature representation. Run a fixed cross-image 1-NN diagnostic for bank-relative scalar geometry and 64-D detail reference direction, including an inner-train leave-one-image-out control. The held-out neighbor map must be frozen using features only before held-out source supervision is opened. This is a no-training source diagnostic; the excluded C2 outer supervision, target-domain data, LOL-v2, and official test remain inaccessible, and clean/reference information remains forbidden at test-time adaptation or deployable inference.