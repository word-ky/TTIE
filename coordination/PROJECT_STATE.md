...
8. **T038 sharpens the unsafe-tail mechanism:** within the 29 T036 PSNR-loss selected states, the newly added common-gain coordinate is much more often anti-restorative than legacy EV+gamma under the frozen T014 energy. Because T014 Sobolev supervision never explicitly covered this later gain tangent, missing coordinate supervision is now a concrete hypothesis, but not yet a causal conclusion. The next controlled question is whether the same gain-tangent deficit is already present on the original source domain; if not, real-domain extrapolation remains the stronger explanation.
