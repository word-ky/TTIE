...
def select(cohort, output, source, device):
    ...
    write(output/'config.json',dict(task='T020-A',source_sha=source,source_code_sha256=code,pipeline_lock_sha256=sha(Path('research_log/T020A_pipeline_lock.json')),
